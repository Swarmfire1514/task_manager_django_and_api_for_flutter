...
Live Website: [https://task-manager-with-django.onrender.com](https://task-manager-with-django.onrender.com)  # Note the website is hosted in free render tier, so it is down now as limit is reached.
